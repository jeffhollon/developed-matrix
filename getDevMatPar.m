...
%   Detailed explanation goes here
    ...
    if size(GroupList,2)==1
        ...
        spmd
            InversesT=zeros(1,NumElements);
            for a=labindex:cores:NumElements
                for b=1:NumElements
        ...
        Inverses = InversesT{1};
        for z=2:cores
            Inverses = Inverses + InversesT{z};
        end
            ...
            CoeffsT = zeros(NumElements);
            for a = 1:cores
                CoeffsT = CoeffsT + Coeffs{a};
            end
            CoeffsT(1,:) = 1:NumElements;
